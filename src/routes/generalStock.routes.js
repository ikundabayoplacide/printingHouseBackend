...
router.get('/items', authorize('ADMIN', 'STOCK', 'HOBE', 'PRODUCTION_MANAGER'), ctrl.getAllItems);
router.get('/items/:id', authorize('ADMIN', 'STOCK', 'HOBE', 'PRODUCTION_MANAGER'), ctrl.getItemById);
...
// Entries (IN)
router.get('/entries', authorize('ADMIN', 'STOCK', 'PRODUCTION_MANAGER'), ctrl.getAllEntries);
router.post('/entries', authorize('ADMIN', 'STOCK'), ctrl.createEntry);

// Sorties (OUT)
router.get('/sorties/my', authorize('HOBE'), ctrl.getMySorties);
router.get('/sorties', authorize('ADMIN', 'STOCK', 'PRODUCTION_MANAGER'), ctrl.getAllSorties);
router.get('/sorties/:id', authorize('ADMIN', 'STOCK', 'PRODUCTION_MANAGER'), ctrl.getSortieById);
