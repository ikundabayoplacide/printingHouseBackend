...
router.get('/items', authorize('ADMIN', 'SUPERVISOR', 'WORKER', 'PRODUCTION_MANAGER'), ctrl.getAllItems);
router.get('/items/:id', authorize('ADMIN', 'SUPERVISOR', 'WORKER', 'PRODUCTION_MANAGER'), ctrl.getItemById);
...
// Sorties (OUT)
router.get('/sorties/my', authorize('SUPERVISOR', 'WORKER'), ctrl.getMySorties);
...
router.post('/sorties', authorize('SUPERVISOR', 'WORKER'), ctrl.createSortie);
